...
public privileged aspect persist {
	...
	void around() : save() {
		...
		try {
			...
			List<Livro> objects = new Vector<Livro>();
...
//		Field id;
//		try {
////			id = thisJoinPoint.getTarget().getClass().getSuperclass().getDeclaredField("_id");
////			id.setAccessible(true);
////			System.out.println("Your internal ID is: "+id.get(thisJoinPoint.getTarget()));
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//
